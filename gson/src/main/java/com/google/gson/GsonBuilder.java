...
public final class GsonBuilder {
  ...
  /**
   * Configures Gson to enable anonymous classes during serialization.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   * @since 2.8.6
   */
  public GsonBuilder enableAnonymousOrLocalClassSerialization() {
    excluder = excluder.enableAnonymousOrLocalClassSerialization();
    return this;
  }
