...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  private boolean serializeAnonymousOrLocalClasses;
  ...
  public Excluder enableAnonymousOrLocalClassSerialization() {
    Excluder result = clone();
    result.serializeAnonymousOrLocalClasses = true;
    return result;
  }
  ...
  public boolean excludeField(Field field, boolean serialize) {
    ...
    if (!serializeAnonymousOrLocalClasses && isAnonymousOrLocal(field.getType())) {
      return true;
    }
  ...
  private boolean excludeClassChecks(Class<?> clazz) {
      ...
      if (!serializeAnonymousOrLocalClasses && isAnonymousOrLocal(clazz)) {
          return true;
      }
